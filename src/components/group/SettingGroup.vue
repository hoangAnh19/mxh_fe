<template>
  <div class="create-group">
    <div class="title">Thông tin nhóm</div>
    <div class="body">
      <b-row>
        <b-col cols="4">
          <div class="form-group">
            <label class="fw-bold"> Tên nhóm</label>
            <input class="form-control" placeholder="Nhập tên nhóm" v-model="nameGroup" />
          <span class="text-danger">{{ errors.nameGroup ?? null }}</span>
          ...
          <div class="form-group">
            ...
            <div class="form-check d-inline-block p-0">
              <input
                ...
                v-model="typeGroup"
              />
              <label for="groupPublic">&nbsp;&nbsp;Công khai</label>
            </div>
            <div class="form-check d-inline-block">
              <input
                ...
                v-model="typeGroup"
              />
              <label for="groupPrivate">&nbsp;&nbsp;Riêng tư</label>
            </div>
          </div>
          <div class="form-group" v-if="typeGroup == 2">
            ...
            >
            <div class="form-group" v-for="ques in countQues" :key="ques">
              ...
              <input class="form-control" v-model="question[ques - 1]" />
          <span class="text-danger">{{ errors.question[ques - 1] ?? null }}</span>

            </div>
            <button class="btn" v-on:click="incQ()">
              <b-icon icon="plus-circle-fill"></b-icon> Thêm câu hỏi
            </button>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea v-model="regulations" class="form-control" rows="10"></textarea>
          </div>
        </b-col>
        <b-col>
          <div class="form-group">
      ...
      <button class="btn btn-success" v-on:click="updateGroup"> Sửa
      </button>
    </div>
  </div>
</template>
...
created() {
  ...
  methods: {
    updateGroup () {
        if (!confirm('Bạn có muốn sửa thông tin nhóm?')) return;
