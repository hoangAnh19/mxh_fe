<template>
  <b-col cols="4" offset="2">
    <div class="personal-information bg-white">
      ...
      <div v-if="!change.username" class="item row">
        ...
        <b-col cols="5">{{ user.first_name + " " + user.last_name }}</b-col>
        <b-col
          v-if="isOwner"
      ...
      <div v-else class="item row">
        ...
        <b-col cols="5">
          <div class="form-check d-inline-block p-0">
            <input type="radio" value="1" id="two" v-model="userNew.gender" />
            <label for="one">Nam</label>
          </div>
          <div class="form-check d-inline-block">
            <input type="radio" value="2" id="three" v-model="userNew.gender" />
            <label for="two">Nữ</label>
          </div>
          <div class="form-check d-inline-block">
            <input type="radio" value="0" id="one" v-model="userNew.gender" />
      ...
      <div v-else class="item row">
        <b-col class="label" cols="4">Ngày sinh</b-col>
        <b-col cols="5">
          <input type="date" class="form-control" v-model="userNew.bird_day" />
  ...
  <b-col cols="4">
    <div class="contact bg-white">
      ...
      <div v-else class="item row">
        ...
        <b-col v-on:click="cancel('email')" cols="3" class="change text-success"
          ><b-icon icon="x-circle"></b-icon> Hủy</b-col
        >
      </div>
      ...
      <div v-else class="item row">
        ...
        <b-col v-on:click="cancel('phone')" cols="3" class="change text-success"
          ><b-icon icon="x-circle"></b-icon> Hủy</b-col
        >
      </div>
  ...
  <b-col class="mt-4" cols="8" offset="2">
    <div class="career bg-white">
      <span class="title"> <b-icon icon="flag-fill"></b-icon> Sự nghiệp</span>
      ...
      <div class="school p-4">
        <div class="fw-bold mb-4">
          ...
          <span v-if="isOwner" class="text-success add" style="float: right">
              ...
              <b-col cols="3" class="form-group">
                <b-row>
                  <b-col>
                    ...
                    <select
                      v-model="education['monthStartEducation'][index]"
                      class="form-control"
                    >
                      <option
                        v-for="month in 12"
                  ...
                  <b-col>
                    ...
                    <select
                      v-model="education['yearStartEducation'][index]"
                      class="form-control"
                    >
                      <option
                        v-for="year in 50"
              ...
              <b-col cols="3" class="form-group">
                <b-row>
                  <b-col>
                    ...
                    <select
                      v-model="education['monthEndEducation'][index]"
                      class="form-control"
                    >
                      <option
                        v-for="month in 12"
                  ...
                  <b-col>
                    <label class="label">
                      Năm {{ education["yearEndEducation"][index] }}</label
                    >
                    <select
                      v-model="education['yearEndEducation'][index]"
                      class="form-control"
                    >
                      <option
                        v-for="year in 50"
      ...
      <div class="job p-4">
        ...
        <div v-if="!workplaceOld">Không có nơi làm việc để hiển thị</div>
        <div
