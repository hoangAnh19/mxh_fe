<template>
  <div class="profile-top">
    ...
    />
    <img class="avatar" v-else src="@/assets/image/default-user-avatar.png" />
    <div class="row cover">
        ...
        <b-row>
          ...
          >
            <div v-if="type_follow != null">
              <b-icon icon="chat-fill" class="text-orange mx-1"></b-icon>Nhắn
              tin
            </div>
          </b-col>
          <b-col
          ...
          >
            ...
            >
              <b-icon icon="check2" class="text-orange mx-1"></b-icon>Đang theo
              dõi
              <div
                v-if="drop_follow"
                v-on:click="unFollow"
          ...
          >
            <div v-if="type_friend == 4" v-on:click="addFriend">
              <b-icon icon="person-plus-fill" class="text-orange mx-1"></b-icon
              >Kết bạn
            </div>
            <div
              v-if="type_friend == 1"
              ...
              class="position-relative"
            >
              <b-icon icon="check2" class="text-orange mx-1"></b-icon>Bạn bè
              <div
                v-if="drop_friend"
                v-on:click="unFriend"
                class="position-absolute drop_follow"
            ...
            <div
              ...
              class="position-relative"
            >
              <b-icon icon="check2" class="text-orange mx-1"></b-icon>Đã gửi lời
              mời
              <div
                v-if="drop_friend"
            ...
            <div
              ...
              class="position-relative"
            >
              <b-icon icon="check2" class="text-orange mx-1"></b-icon>Phản hồi
              <div v-if="drop_friend" class="position-absolute drop_follow">
                <div v-on:click="acceptFriend">Chấp nhận</div>
                <br />
                <div v-on:click="unRequestFriend">Xóa lời mời</div>
              </div>
            </div>
          </b-col>
          <b-col
          ...
          >
            ...
            >
              ...
              <div v-if="drop_setting" class="position-absolute drop_setting">
