      ...
      <b-col
        ...
        >
          <div v-if="friend_ !== 4" class="item friend">
            <div v-on:click="addFriend" v-if="friend_ == 0">Kết bạn</div>
            <div v-on:click="unFriend" v-if="friend_ == 1">Hủy kết bạn</div>
          ...
          <div class="item follow">
            <div v-if="follow_ == 0" v-on:click="follow">Theo dõi</div>
            <div v-if="follow_ == 1" v-on:click="unFollow">Bỏ theo dõi</div>
          </div>
          <div class="prevent">
            <div v-on:click="prevent" v-if="friend_ !== 4">Chặn</div>
            <div v-on:click="unPrevent" v-if="friend_ == 4">Bỏ chặn</div>
          </div>
        </div>
      </b-col>
    </b-row>
